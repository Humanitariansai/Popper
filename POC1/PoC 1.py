...
def get_assertion_prompt(input_text: str) -> str:
    ...
    base_prompt = dedent("""
        ...
        Keywords: is, refers to, belongs to
        Example: "Neurons are cells that transmit signals."

        Causal/Mechanistic
        Describes cause-effect or mechanisms
        Keywords: causes, leads to, activates
        Example: "UV radiation causes DNA damage."

        Quantitative/Statistical
        Presents numeric values or measurements
        Keywords: %, rate, concentration, X per Y
        Example: "Prevalence is 9.3%."

        Observational/Correlational
        Reports observed links without claiming causation
        Keywords: associated with, observed in
        Example: "Smokers tend to have higher blood pressure."

        Methodological/Procedural
        Describes scientific techniques/methods
        Keywords: is used to, technique for
        Example: "PCR amplifies DNA."

        Historical/Attributive
        Attributes discoveries or ideas to sources/time
        Keywords: discovered by, described in
        Example: "DNA's structure was identified by Watson and Crick."
